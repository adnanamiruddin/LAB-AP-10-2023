...
def template():
    os.chdir("invoices")
    invoice_nama = format_invoices + ".txt"
    os.path.join("invoices", invoice_nama)
    with open(str(invoice_nama), 'w') as file:
        file.write("\n" + "_" * 60 + "\n" + "\n")
        file.write("TOKO HAIIYA YOO".center(60) + "\n")
        ...
        file.write("\n" + ("=" * 60))
        file.write("\n" + "TERIMA KASIH TELAH BERBELANJA".center(60))
        file.write("\n" + ("=" * 60))
        file.write("\n" + "\n" + "_" * 60 + "\n" + "\n")
